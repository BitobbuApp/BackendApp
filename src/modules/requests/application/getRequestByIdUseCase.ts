    ...
    protected async implementation(id: string): Promise<any> {
        ...
        return {
            ...
            company: request.company ? {
                ...
                transaction_count: request.company.transaction_count,
                avg_quality: request.company.avg_quality,
                avg_compliance_seller: request.company.avg_compliance_seller,
                avg_communication_seller: request.company.avg_communication_seller,
                avg_price: request.company.avg_price,
                seller_review_count: request.company.seller_review_count,
                avg_compliance_buyer: request.company.avg_compliance_buyer,
                avg_reliability: request.company.avg_reliability,
                avg_communication_buyer: request.company.avg_communication_buyer,
                buyer_review_count: request.company.buyer_review_count,
