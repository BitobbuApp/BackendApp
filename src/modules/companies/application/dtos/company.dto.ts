...
const companyWithRelationsSchema = Joi.object({
    ...
    can_buy: Joi.boolean(),
    can_sell: Joi.boolean(),
    is_founder_badge: Joi.boolean(),
    founding_year: Joi.number().integer().allow(null).optional(),
    monthly_transactions_id: Joi.string().allow(null, ''),
    company_size_id: Joi.string().allow(null, ''),
    logo_url: Joi.string().allow(null, ''),
