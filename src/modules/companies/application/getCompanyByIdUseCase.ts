...
export class GetCompanyByIdUseCase extends UseCase<string, any> {
    ...
    protected outputSchema: Joi.Schema = Joi.object({
        ...
        seller_review_count: Joi.number().optional().default(0),
        buyer_review_count: Joi.number().optional().default(0),
        avg_quality: Joi.number().optional().default(0),
        avg_compliance_seller: Joi.number().optional().default(0),
        avg_communication_seller: Joi.number().optional().default(0),
        avg_price: Joi.number().optional().default(0),
        avg_compliance_buyer: Joi.number().optional().default(0),
        avg_reliability: Joi.number().optional().default(0),
        avg_communication_buyer: Joi.number().optional().default(0),
